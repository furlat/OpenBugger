...
modified_simple_script, error, counter = logic_bug.inject(
    simple_script_str, "easy", num_errors=3
)
...
modified_medium_script, error, counter = logic_bug.inject(
    medium_script_str, "medium", num_errors=3
)
...
modified_hard_script, error, counter = logic_bug.inject(
    hard_script_str, "hard", num_errors=1
)
